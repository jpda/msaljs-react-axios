...
export class OboView extends React.Component<Props, State> {
    state: State;
    auth: AuthService;
    ...
    constructor(props: Props, state: State) {
        ...
        this.scopeConfiguration = { scopes: ["/.default"] };
    }
    ...
    fetchData(token: AuthResponse) {
        ...
        console.debug("obo: got access token: " + token.accessToken.substr(0, 10) + "...");
